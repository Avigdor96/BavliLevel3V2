...
public class Methods {
    //בדיקת סוג שורה(ריקת מסכת, דף או תוכן
    ...
    // יצירת תיקייה של הבבלי מחולק למסכתות ודפים
...
//
    ...
    // בקשת שם של ספר ובודק תקינות ומחזיר מיקום של הספר על ידי קריאה לפונקציה
    ...
    // מקבל מיקום של ספר ומבקש דףת בודק תקינות הדף ומחזיר את המיקום שלו על ידי קריאה לפונקציה
